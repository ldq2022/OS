...
static int sys_practice(int input);
...
/* Halt system call. */
static int sys_halt(void) { shutdown_power_off(); }
...
/* Wait system call. */
static int sys_wait(tid_t child) { return process_wait(child); }
...
static int sys_practice(int input) { return input + 1; }
